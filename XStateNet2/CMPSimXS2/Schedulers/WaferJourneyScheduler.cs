...
public class WaferJourneyScheduler
{
    ...
    private readonly Dictionary<string, StationViewModel> _stations = new();
    ...
    /// </summary>
    public void RegisterStation(string stationName, StationViewModel station)
    {
        lock (_lock)
        {
    ...
    {
        Logger.Instance.Info("WaferJourneyScheduler", $"[Wafer {wafer.Id}] Starting journey: Carrier → Polisher");
    ...
    {
        Logger.Instance.Info("WaferJourneyScheduler", $"[Wafer {wafer.Id}] Returning to Carrier: Buffer → Carrier");
    ...
    private void OnWaferCompleted(int waferId)
    {
        ...
        Logger.Instance.Info("WaferJourneyScheduler", $"[Wafer {waferId}] ✓ COMPLETED - Journey finished, returned to Carrier");
    ...
    /// Get station by name
    /// </summary>
    private StationViewModel? GetStation(string stationName)
    {
