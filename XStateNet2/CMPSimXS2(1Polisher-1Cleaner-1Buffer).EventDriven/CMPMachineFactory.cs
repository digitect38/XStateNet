...
public static class CMPMachineFactory
{
    ...
    public static IActorRef Create(ActorSystem actorSystem, string machineJson)
    {
        ...
        machineBuilder
            ...
            .WithGuard("cleanerNotLocked", CMPGuards.CleanerNotLocked)
            .WithGuard("bufferNotLocked", CMPGuards.BufferNotLocked)
            ...
            .WithGuard("cleanSuccessful", CMPGuards.CleanSuccessful)
            .WithGuard("bufferSuccessful", CMPGuards.BufferSuccessful);
