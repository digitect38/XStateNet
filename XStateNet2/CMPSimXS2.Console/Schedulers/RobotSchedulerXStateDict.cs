...
/// <summary>
/// XState-based Robot Scheduler - Dictionary Baseline
/// Uses standard Dictionary (NO FrozenDictionary optimization)
/// For performance comparison to measure FrozenDictionary benefit
/// </summary>
public class RobotSchedulerXStateDict : IRobotScheduler
{
    private readonly IActorRef _machine;
    private readonly SchedulerContext _context;
    private readonly TimeSpan _defaultTimeout = TimeSpan.FromSeconds(5);

    public RobotSchedulerXStateDict(ActorSystem actorSystem, string? actorName = null)
    {
        ...
        _machine = factory.FromJson(MachineJson)
            ...
            .WithFrozenDictionary(false)  // DISABLE FrozenDictionary optimization
            .BuildAndStart(actorName);

        Logger.Instance.Log("[RobotSchedulerXStateDict] Initialized with XState machine (Dictionary baseline)");
    }
